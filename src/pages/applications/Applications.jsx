...
const Applications = () => {
  const { postulations } = useSelector((state) => state.app)
  return (
    <main className="lg:w-[1400px] mx-auto h-full w-full lg:px-0 px-5 py-10">
      {postulations && postulations.length > 0 ? (
        ...
        <div className="w-full lg:h-[600px] flex justify-center items-center">
          <h2>Aún no has aplicado a ninguna oferta</h2>
        </div>
      )}
    </main>
  )
